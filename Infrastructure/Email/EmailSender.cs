...
//        Console.WriteLine($"[RESEND] ApiKey is null or empty: {string.IsNullOrEmpty(apiKey)}");
//        var from = configuration["Email:From"] ?? "onboarding@resend.dev";

//        var client = httpClientFactory.CreateClient();
//        Console.WriteLine($"[RESEND] ApiKey: {apiKey?[..10]}...");
//        Console.WriteLine($"[RESEND] From: {from}");
//        Console.WriteLine($"[RESEND] To: {email}");
